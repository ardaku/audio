...
dl_api::linker!(extern "C" Ffi "libopus.so.0" {
    fn opus_strerror(a: libc::c_int) -> *const libc::c_char;
    fn opus_get_version_string() -> *const libc::c_char;
    fn opus_encoder_create(a: libc::c_int, b: libc::c_int,
        c: Application, d: *mut libc::c_int) -> *mut OpusEncoder;
    fn opus_encode(a: *mut OpusEncoder, b: *const libc::c_short,
        c: libc::c_int, d: *mut libc::c_uchar,
        e: libc::c_int) -> libc::c_int;
    fn opus_encode_float(a: *mut OpusEncoder,
        b: *const libc::c_float, c: libc::c_int,
        d: *mut libc::c_uchar, e: libc::c_int) -> libc::c_int;
    fn opus_encoder_destroy(a: *mut OpusEncoder) -> ();
//	fn opus_encoder_ctl(*mut OpusEncoder, libc::c_int, ...)
//		-> libc::c_int;
    fn opus_decoder_create(a: libc::c_int, b: libc::c_int,
        c: *mut libc::c_int) -> *mut OpusDecoder;
    fn opus_decode(a: *mut OpusDecoder, b: *const libc::c_uchar,
        c: libc::c_int, d: *mut libc::c_short, e: libc::c_int,
        f: libc::c_int) -> libc::c_int;
    fn opus_decode_float(a: *mut OpusDecoder, b: *const libc::c_uchar,
        c: libc::c_int, d: *mut libc::c_float, e: libc::c_int,
        f: libc::c_int) -> libc::c_int;
//	fn opus_decoder_ctl(*mut OpusDecoder, libc::c_int,
//		...) -> libc::c_int,
    fn opus_decoder_destroy(a: *mut OpusDecoder) -> ();
    fn opus_packet_parse(a: *const libc::c_uchar,
        b: libc::c_int, c: *mut libc::c_uchar,
        d: *mut *const libc::c_uchar, e: *mut libc::c_short,
        f: *mut libc::c_int) -> libc::c_int;
    fn opus_packet_get_bandwidth(a: *const libc::c_uchar)
        -> libc::c_int;
    fn opus_packet_get_samples_per_frame(a: *const libc::c_uchar,
        b: libc::c_int) -> libc::c_int;
    fn opus_packet_get_nb_channels(a: *const libc::c_uchar)
        -> libc::c_int;
    fn opus_packet_get_nb_frames(a: *const libc::c_uchar,
        b: libc::c_int) -> libc::c_int;
    fn opus_packet_get_nb_samples(a: *const libc::c_uchar,
        b: libc::c_int, c: libc::c_int) -> libc::c_int;
    fn opus_decoder_get_nb_samples(a: *const OpusDecoder,
        b: *const libc::c_uchar, c: libc::c_int) -> libc::c_int;
    fn opus_pcm_soft_clip(a: *mut libc::c_float,
        b: libc::c_int, c: libc::c_int, d: *mut libc::c_float) -> ();
    fn opus_repacketizer_init(a: *mut OpusRepacketizer)
        -> *mut OpusRepacketizer;
    fn opus_repacketizer_create() -> *mut OpusRepacketizer;
    fn opus_repacketizer_destroy(a: *mut OpusRepacketizer) -> ();
    fn opus_repacketizer_cat(a: *mut OpusRepacketizer,
        b: *const libc::c_uchar, c: libc::c_int) -> libc::c_int;
    fn opus_repacketizer_out_range(a: *mut OpusRepacketizer, b: libc::c_int,
        c: libc::c_int, d: *mut libc::c_uchar, e: libc::c_int)
            -> libc::c_int;
    fn opus_repacketizer_get_nb_frames(a: *mut OpusRepacketizer)
        -> libc::c_int;
    fn opus_repacketizer_out(a: *mut OpusRepacketizer, b: *mut libc::c_uchar,
        c: libc::c_int) -> libc::c_int;
    fn opus_packet_pad(a: *mut libc::c_uchar, b: libc::c_int, c: libc::c_int)
        -> libc::c_int;
    fn opus_packet_unpad(a: *mut libc::c_uchar, b: libc::c_int)
        -> libc::c_int;
});
...
impl ErrorCode {
    ...
    pub fn description(self) -> &'static str {
        ...
        unsafe { CStr::from_ptr((FFI.opus_strerror)(self as c_int)) }
            .to_str()
            .unwrap()
    }
}
...
impl Encoder {
    ...
    pub fn new(sample_rate: u32, channels: Channels, mode: Application) -> Result<Encoder> {
        let mut error = 0;
        let ptr = unsafe {
            (FFI.opus_encoder_create)(sample_rate as i32, channels as c_int, mode, &mut error)
        };
